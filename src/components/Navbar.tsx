        ...
        <div className="flex items-center justify-between h-20 relative">
          ...
          <div className="hidden md:block ml-auto">
            <a
              ...
              className="px-6 py-2.5  bg-gradient-to-br from-sky-500 via-blue-500 to-indigo-600 text-white rounded-full font-medium hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
              Register Now
            </a>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden  border-t bg-slate-50 border-gray-200">
          <div className="px-5 py-4 space-y-4">
            ...
            <button onClick={() => scrollToSection('mazha')} className="block w-full text-left font-medium">
              Mazha
            </button>

            <button onClick={() => scrollToSection('previous-programmes')} className="block w-full text-left font-medium">
              Previous Programmes
            </button>
           ...
           {/* <button onClick={() => scrollToSection('speakers')} className="block w-full text-left font-medium">
            ...
            <a
              href="https://forms.gle/XcMaQU3aqxwMuBCt5"
              target="_blank"
              className="block w-full text-center px-6 py-2.5  bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-700 text-white rounded-full"
            >
              Register Now
            </a>
