        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-800 rounded-2xl flex items-center justify-center mb-4 mx-auto">
