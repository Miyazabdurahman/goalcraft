  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 max-w-md mx-auto">
        ...
        <div className="w-full bg-gradient-to-r from-purple-600 to-blue-600 p-8 rounded-l  scale-100  text-white">
          <p className="text-sm uppercase tracking-wide opacity-90">
            🔥 Early Bird
          </p>

          <h3 className="text-5xl font-bold my-4">₹299</h3>

          <p className="text-sm mb-4">
            Limited time offer • Few seats left
          </p>
        ...
        <div className="min-w-full bg-gray-800 p-5 rounded-l opacity-100 text-white">
          ...
          <h3 className="text-2xl font-semibold">₹499</h3>
        </div>
